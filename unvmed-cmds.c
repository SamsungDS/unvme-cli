...
int unvme_read(int argc, char *argv[], struct unvme_msg *msg)
{
	...
	struct opt_table opts[] = {
		...
		OPT_WITH_ARG("-z|--data-size", opt_set_uintval, opt_show_uintval, &data_size, "[M] Read data buffer size in bytes"),
...
int unvme_write(int argc, char *argv[], struct unvme_msg *msg)
{
	...
	struct opt_table opts[] = {
		...
		OPT_WITH_ARG("-z|--data-size", opt_set_uintval, opt_show_uintval, &data_size, "[O] Logical block size in bytes"),
...
int unvme_io_passthru(int argc, char *argv[], struct unvme_msg *msg)
{
	...
	struct opt_table opts[] = {
		...
		OPT_WITH_ARG("-n|--namespace-id", opt_set_uintval, opt_show_uintval, &nsid, "[M] Namespace ID"),
		OPT_WITH_ARG("-l|--data-len", opt_set_uintval, opt_show_uintval, &data_len, "[O] Data length in bytes"),
