...
static struct command cmds[] = {
	...
	{"create-ns",		"Create Namespace",					UNVME_DRIVER_CMD | UNVME_DAEMON_CMD | UNVME_DEV_CMD,	unvme_create_ns},
	{"delete-ns",		"Delete Namespace",					UNVME_DRIVER_CMD | UNVME_DAEMON_CMD | UNVME_DEV_CMD,	unvme_delete_ns},
	{"attach-ns",		"Attach Namespace",					UNVME_DRIVER_CMD | UNVME_DAEMON_CMD | UNVME_DEV_CMD,	unvme_attach_ns},
	{"detach-ns",		"Detach Namespace",					UNVME_DRIVER_CMD | UNVME_DAEMON_CMD | UNVME_DEV_CMD,	unvme_detach_ns},
